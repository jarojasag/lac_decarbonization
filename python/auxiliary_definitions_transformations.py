...
def transformation_test_elec(
    ...
    for region in all_regions:
        ...
        df_in = df_input[df_input[field_region] == region].reset_index()
...
def transformation_inen_shift_modvars(
    ...
    for region in all_regions:
        ...
        df_in = df_input[df_input[field_region] == region].sort_values(by = [model_attributes.dim_time_period]).reset_index()
        df_in_new = df_in.copy()
        vec_tp = list(df_in[model_attributes.dim_time_period])
        n_tp = len(df_in)
