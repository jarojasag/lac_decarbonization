...
class LHSDesign:
	...
	def generate_lhs(self,
		...
		if retun_none:
			self._log(f"Warning in generate_lhs: one or more elements are missing. If not initialized with n_factors_l, n_factors_x, or n_trials, update with self._set_lhs", type_log = "warning")
			return None
