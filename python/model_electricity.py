...
class ElectricEnergy:
    ...
    def __init__(self,
        ...
        self.modvar_entc_fuel_production_energy_input_ratio = "Fuel Production Energy Input Ratio"
        self.modvar_entc_fuel_production_energy_input_ratio_elec = "Fuel Production Energy Input Ratio With Electrification"
