...
def transformation_ippu_reduce_f_gasses(
    ...
    **kwargs
    ...
    - dict_magnitude: magnitude of reductino as a proportion (e.g., enter 0.9
        to reduce by 90%) OR dictionary mapping gasses (only gasses, not 
        variables) to a reduction value
